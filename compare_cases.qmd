...
@render.data_frame
def cap_df():
    return render.DataTable(cap_cases(), filters=True)
...
@render.data_frame
def gen_df():
    return render.DataTable(gen_cases(), filters=True)
...
@render.data_frame
def tx_exp_df():
    return render.DataTable(tx_exp_cases(), filters=True)
