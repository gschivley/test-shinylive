...
cap = pd.read_csv(
    "https://raw.githubusercontent.com/gschivley/MIP_results_comparison/main/compiled_results/all/capacity.csv.gz"
)
gen = pd.read_csv(
    "https://raw.githubusercontent.com/gschivley/MIP_results_comparison/main/compiled_results/all/generation.csv.gz"
)
emiss = pd.read_csv(
...
def single_op_cost_chart(
    ...
    base = (
        ...
        .encode(
            # xOffset="model:N",
            x=alt.X(VAR_ABBR_MAP[x_var]).sort(order_dict().get(x_var)).title(title_case(x_var)),
