...
all_techs = ['Battery', 'CCS', 'Coal', 'Distributed Solar', 'Geothermal',
       'Hydro', 'Hydrogen', 'Natural Gas CC', 'Natural Gas CT', 'Nuclear',
       'Solar', 'Wind']
```
# {.sidebar}
```{python}
...
ui.input_selectize(
    "tech_type", "Technology types", choices=all_techs, selected=all_techs, multiple=True
)
...
def emiss_cases():
    return emiss.loc[
        ...
        & (emiss["planning_year"].isin(int_years()))
...
def tx_exp_cases():
    return tx_exp.loc[
        ...
        & (tx_exp["planning_year"].isin(int_years()))
